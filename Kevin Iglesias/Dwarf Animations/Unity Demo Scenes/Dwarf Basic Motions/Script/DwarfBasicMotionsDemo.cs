...
{
    [System.Serializable]
    public class DwarfBasicAnimationEntry
    {
    ...
    [System.Serializable]
    public class DwarfBasicCharacterEntry
    {
    ...
    public class DwarfBasicMotionsDemo : MonoBehaviour
    {
        [Header("Camera")]
        ...
        [Header("Characters")]
        [SerializeField] private DwarfBasicCharacterEntry[] availableCharacters;
        ...
        [Header("Animations")]
        [SerializeField] private DwarfBasicAnimationEntry[] availableAnimations;
    ...
    ///CHARACTER SELECTION
        public void SelectCharacter(int index)
        {
            ...
            for(int i = 0; i < availableCharacters.Length; i++)
            {
                DwarfBasicCharacterEntry entry = availableCharacters[i];
            ...
            DwarfBasicCharacterEntry selectedEntry = availableCharacters[index];
    ...
    ///ANIMATION SELECTION
        public void PlayAnimation(int index, int newAnimationType)
        {
            ...
            if(newAnimationType == 0)
            {
                ...
                overrideController["DwarfM@Idle02"] = availableAnimations[index].clip;
        ...
        private void UpdateProps(int activeIndex, int animationLayerType)
        {
            ...
            DwarfBasicAnimationEntry entry = availableAnimations[activeIndex];
        ...
        private void CreateSubFolderButtons(string folderPath)
        {
            ...
            foreach (DwarfBasicAnimationEntry entry in availableAnimations)
            {
        ...
        private void CreateAnimationButtonsInFolder(string folderPath)
        {
            ...
            for(int i = 0; i < availableAnimations.Length; i++)
            {
                DwarfBasicAnimationEntry entry = availableAnimations[i];
        ...
        private void SelectCurrentAnimationButtonInOpenFolder()
        {
            ...
            DwarfBasicAnimationEntry currentEntry = availableAnimations[selectedIndex];
    ...
    ///ANIMATION FOLDER HELPERS
        private bool IsDirectChildFolder(DwarfBasicAnimationEntry entry, string currentFolder, out string childPath, out string childName)
        {
            childPath = null;
            childName = null;
    ...
    ///ANIMATIONS LOAD (EDITOR ONLY)
        ...
        void PopulateAnimationsFromFolder()
        {
            ...
            System.Collections.Generic.List<DwarfBasicAnimationEntry> entries = new();
            ...
            foreach(string guid in guids)
            {
                ...
                entries.Add(new DwarfBasicAnimationEntry
                {
                    clip = clip,
